    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="editNavbar.php">
          ...
          <span class="nav-link-text ms-1">Edit Navbar</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link  " href="editContactDetails.php">
          ...
          <span class="nav-link-text ms-1">Edit Contact Details</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="theme.php">
          ...
          <span class="nav-link-text ms-1">Edit Theme</span>
        </a>
      </li>
    </ul>
  </div>
  <div class="sidenav-footer mx-4 fixed-bottom">
    <a href="logout.php"><button class="btn btn-outline-secondary"><i class="fa fa-right-from-bracket"></i> &nbsp; Logout</button></a>
  </div>
</aside>